...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private static final int MY_PERMISSION_SMS=0;
    public int flag = 0;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (ContextCompat.checkSelfPermission ( this,Manifest.permission.SEND_SMS ) != PackageManager.PERMISSION_GRANTED){
            if (ActivityCompat.shouldShowRequestPermissionRationale ( this,Manifest.permission.SEND_SMS )){
                ...
                ActivityCompat.requestPermissions ( this,new String[] {Manifest.permission.SEND_SMS}, MY_PERMISSION_SMS );
            }
        }
    }
    ...
    protected void sendMessage(){
        ...
        msg = "Votre chauffeur a dormi le " + " "+ currentDateTimeString + "  Latitude "+ latitude+ "   Longitude :"+longitude;
        phoneNum = "+212699029868";
        ...
        runOnUiThread ( new Runnable () {
            @Override
            public void run() {
                final Toast toast =Toast.makeText (getApplicationContext () , "SENT !", Toast.LENGTH_SHORT );
                toast.show ();
    ...
    private void getLocattion() {
        if (ActivityCompat.checkSelfPermission ( FaceTrackerActivity.this, Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission ( FaceTrackerActivity.this,
            ...
            if (LocationGps !=null){
                ...
                double lat = LocationNetwork.getAltitude ();
                ...
                double lat = LocationPassive.getAltitude ();
